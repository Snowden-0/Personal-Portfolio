...
import { MdSchool, MdWork, MdCode, MdWeb } from 'react-icons/md';
import { TbBrandJavascript, TbBrandReact, TbBrandHtml5, TbBrandCss3, TbBrandTailwind, TbBrandNodejs, TbBrandGit } from "react-icons/tb";
...
const Portfolio = () => {
    ...
    // Skill to show animated
    const skills = [
        "JavaScript", "React", "Node.js", "Tailwind CSS", "MongoDB", "Express", "HTML", "CSS"
    ];
    ...
    return (
        ...
        >
                ...
                <div className="container mx-auto px-6 md:px-12">
                    <ul className="flex justify-center items-center space-x-10">
                        {navbarItems.map((item) => (
                            <motion.li
                                key={item.id}
                                className={`relative group cursor-pointer ${activeSection === item.id
                                    ? 'text-blue-400'
            ...
            <div className="container mx-auto px-6 md:px-12 py-16 relative z-20">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 w-full mt-8">
                                ...
                                <div className="md:col-span-3 flex flex-col justify-center">
                                    <motion.div
                                        ...
                                        className="mb-2"
                                    >
                                        <span className="text-lg text-emerald-400 font-medium">Hello, my name is</span>
                                    </motion.div>
                                    ...
                                    >
                                        <div className="relative h-14 overflow-hidden mt-6">
                                            ...
                                            <p className="text-2xl md:text-3xl font-semibold text-gray-200 pl-4 border-l-4 border-transparent">
                                                <span className="text-indigo-300">Aspiring</span> Software Engineer
                                            </p>
                                        </div>
                                    </motion.div>
                                    
                                    <motion.p 
                                        className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mt-6"
                                        initial={{ opacity: 0, y: 30 }}
                                        animate={{ opacity: 1, y: 0 }}
                                    ...
                                    >
                                        ...
                                        <div className="w-full h-full max-h-96 bg-gray-900/70 backdrop-blur-sm rounded-xl p-4 border border-gray-800 shadow-xl overflow-hidden">
                                            ...
                                            <div className="text-sm font-mono space-y-2 text-gray-300">
                                                <div>
                                                    <span className="text-purple-400">const</span> <span className="text-green-400">developer</span> <span className="text-white">=</span> <span className="text-indigo-400">{'{'}</span>
                                                </div>
                                                <div className="pl-4">
                                                    <span className="text-emerald-400">name</span>: <span className="text-yellow-300">'Muhammad Ubaid ur Rehman'</span>,
                                                </div>
                                                <div className="pl-4">
                                                    <span className="text-emerald-400">role</span>: <span className="text-yellow-300">'Software Engineer'</span>,
                                                </div>
                                                <div className="pl-4">
                                                    <span className="text-emerald-400">skills</span>: [<span className="text-yellow-300">'React'</span>, <span className="text-yellow-300">'JavaScript'</span>, <span className="text-yellow-300">'Node.js'</span>],
                                                </div>
                                                <div className="pl-4">
                                                    <span className="text-emerald-400">location</span>: <span className="text-yellow-300">'Islamabad'</span>,
                                                </div>
                                                <div className="pl-4">
                                                    <span className="text-purple-400">code</span>: <span className="text-indigo-400"> </span> <span className="text-indigo-400">{'{'}</span>
                                                </div>
                                                <div className="pl-8">
                                                    <span className="text-purple-400">return</span> <span className="text-yellow-300">'creative solutions'</span>;
                                                </div>
                                                <div className="pl-4"><span className="text-indigo-400">{'}'}</span>,</div>
                                                <div className="pl-4">
                                                    <span className="text-purple-400">learnNewTech</span>: <span className="text-indigo-400">function</span>() <span className="text-indigo-400">{'{'}</span>
                                                </div>
                                                <div className="pl-8 whitespace-nowrap overflow-hidden">
                                                    ...
                                                    >
                                                        <span className="text-purple-400">this</span>.<span className="text-emerald-400">skills</span>.<span className="text-blue-400">push</span>(<span className="text-yellow-300">'new technology'</span>);
                                                    </motion.span>
                                                </div>
                                                <div className="pl-4"><span className="text-indigo-400">{'}'}</span></div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                ...
                                >
                                    ...
                                    <p className="text-xl text-gray-300 leading-relaxed">
                                        A highly motivated and skilled Computer Science student at the
                                        International Islamic University, Islamabad, with a strong
                                        foundation in programming and web development. Eager to apply
                                        technical skills and passion for innovation to create impactful
                                        solutions.
                                    </p>
                                </motion.div>
                                ...
                                <motion.div
                                    ...
                                    className="bg-gray-900/40 backdrop-blur-sm p-8 rounded-xl shadow-glow border border-gray-800"
                                >
                                    <h3 className="text-2xl font-semibold mb-4 text-blue-400">My passion</h3>
                                    <p className="text-xl text-gray-300 leading-relaxed">
                                        Passionate about crafting efficient and elegant solutions to complex problems.
                                        I thrive on challenges and constantly seek opportunities to expand my knowledge
                                        and refine my abilities in the ever-evolving field of technology. My goal is to
                                        contribute meaningfully to innovative projects and make a positive impact
                                ...
                                >
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {[
                                            ...
                                            >
                                                {skill.icon && <skill.icon className="mr-2 h-5 w-5 text-blue-400" />}
                                                {skill.name}
                                            </motion.span>
                                        ))}
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {[
                                            ...
                                            >
                                                {skill.icon && <skill.icon className="mr-2 h-5 w-5 text-purple-400" />}
                                                {skill.name}
                                            </motion.span>
                                        ))}
                                    </div>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {[
                                            ...
                                            <motion.span
                                                ...
                                                animate={{ opacity: 1, scale: 1 }}
                                                transition={{ delay: 0.3 + index * 0.1, duration: 0.4 }}
                                                whileHover={{ scale: 1.1, backgroundColor: "rgba(52, 211, 153, 0.2)" }}
                                            >
                                                {skill.name}
                                            </motion.span>
                                        ))}
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {[
                                            ...
                                            <motion.span
                                                ...
                                                animate={{ opacity: 1, scale: 1 }}
                                                transition={{ delay: 0.3 + index * 0.1, duration: 0.4 }}
                                                whileHover={{ scale: 1.1, backgroundColor: "rgba(107, 114, 128, 0.2)" }}
                                            >
                                                {skill.icon && <skill.icon className="mr-2 h-5 w-5 text-gray-400" />}
                                                {skill.name}
                                            </motion.span>
                                        ))}
                                    </div>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {[
                                    {
                                        title: "Hangman Game",
                                        description: "Interactive word-guessing game built with React, featuring animations and custom UI.",
                                        tags: ["React", "JavaScript", "CSS"],
                                        link: "https://github.com/Snowden-0/Hangman-Game"
                                    },
                                    {
                                        title: "Solaris 3D Solar System",
                                        description: "Interactive 3D solar system visualization using Three.js and React.",
                                        tags: ["React", "Three.js", "JavaScript"],
                                        link: "https://github.com/Snowden-0/Solaris"
                                    },
                                    {
                                        title: "Physics Simulation",
                                        description: "2D physics simulation with interactive objects and realistic physics using Matter.js.",
                                        tags: ["JavaScript", "Matter.js", "HTML Canvas"],
                                        link: "https://github.com/Snowden-0/Physics-Simulation"
                                    },
                                    {
                                        title: "Digital Clock",
                                        description: "Elegant digital clock with dark mode and various time formats.",
                                        tags: ["JavaScript", "CSS", "HTML"],
                                        link: "https://github.com/Snowden-0/Digital-Clock"
                                    },
                                    {
                                        title: "News Website",
                                        description: "Modern news aggregator with real-time updates and personalized feed.",
                                        tags: ["React", "Node.js", "MongoDB"],
                                        link: "https://github.com/Snowden-0/News-Website"
                                    },
                                    {
                                        title: "Portfolio Website",
                                        description: "This interactive portfolio showcasing my projects and skills.",
                ...
                {/* Education Section - Redesigned with cards instead of timeline for better responsiveness */}
<AnimatePresence mode="wait">
                ...
                {[
                    {
                        ...
                        period: "2021 - 2025",
                        description: "Pursuing a degree in Computer Science with focus on software development, data structures, and algorithms.",
                    ...
                    },
                    {
                        ...
                        organization: "Udemy",
                        period: "2022 - 2023",
                        description: "Completed comprehensive course covering React, Node.js, MongoDB, and modern web development practices.",
                    ...
                    },
                    {
                        ...
                        period: "2023 - Present",
                        description: "Developing responsive web applications and providing technical solutions for various clients.",
                    ...
                    <motion.div
                        key={index}
                        className="bg-gradient-to-br from-gray-900/70 to-gray-800/30 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-gray-700/50 hover:border-cyan-700/50 transition-colors duration-300"
                        initial={{ opacity: 0, y: 30 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        ...
                        <div className="p-6 flex flex-col md:flex-row gap-4">
                            ...
                            <div className="flex-grow">
                                ...
                                <div className="inline-block px-3 py-1 mb-3 text-sm text-cyan-200 bg-cyan-900/30 rounded-full border border-cyan-800/30">
                                    {item.period}
                                </div>
